...
async def refe_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Crear mensaje para el canal con nuevo formato
    caption = (
        f"<b>🏛️ OLIMPO BINS 🏛️</b>\n\n"
        f"<b>Hora:</b> {hora}\n"
        f"<b>Fecha:</b> {fecha}\n"
        f"<b>Referencias:</b> {references_count}\n"
        f"<b>Informes del grupo:</b> <a href=\"https://t.me/olimpobinsrefes/4237\">Aqui</a>"
    )
...
async def exportar_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
...
def main():
    ...
    # Comando de Exportación (oculto, solo admin, no aparece en menú)
