...
def create_health_app():
    """Crea una aplicación FastAPI simple para healthchecks"""
    app = FastAPI()
    
    @app.get("/health")
    async def health_check():
        """Endpoint de healthcheck para Railway"""
        return {"status": "ok", "service": "El Buen Samaritano"}
    
    @app.get("/")
    async def root():
        """Endpoint raíz"""
        return {"message": "El Buen Samaritano Bot - Health Check Service"}
