...
HEAVY_COMMANDS = {"archivo", "importar", "limpieza", "scan", "todosmas", "todosmenos", "mensaje", "estado", "ver", "setplan", "listar", "idinfo"}
...
async def security_guard_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_valid_callback_data(query.data):
        ...
        raise ApplicationHandlerStop
    if query.data.startswith(("estado_", "admin_menu_", "ver_", "setplan_", "listar_", "archivo_", "importar_", "idinfo_")) and user_id not in ADMIN_IDS:
